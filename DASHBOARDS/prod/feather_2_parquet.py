...
PI=['CWRM_2D','NFB_2D']
folder='TILE' # SECTION, PLAN, PT_ID, TILE

for pi in PI:
    print(pi)
    print('GERBL2_2014_ComboA_STO_330')
    convert_feather_to_parquet(
        src_root=fr"\\ECQCG1JWPASP002\projets$\GLAM\Dashboard\ISEE_Dash_portable\ISEE_POST_PROCESS_DATA_3\{pi}\YEAR\{folder}\GERBL2_2014_ComboA_STO_330",
        dst_root=fr"D:\GLAM_DASHBOARD\PARQUET_TEST\{pi}\YEAR\{folder}\GERBL2_2014_ComboA_STO_330")
    print('GERBL2_2014_ComboA_RCP45')
    convert_feather_to_parquet(
        src_root=fr"\\ECQCG1JWPASP002\projets$\GLAM\Dashboard\ISEE_Dash_portable\ISEE_POST_PROCESS_DATA_3\{pi}\YEAR\{folder}\GERBL2_2014_ComboA_RCP45",
        dst_root=fr"D:\GLAM_DASHBOARD\PARQUET_TEST\{pi}\YEAR\{folder}\GERBL2_2014_ComboA_RCP45")
    print('GERBL2_2014_ComboA')
    convert_feather_to_parquet(
        src_root=fr"\\ECQCG1JWPASP002\projets$\GLAM\Dashboard\ISEE_Dash_portable\ISEE_POST_PROCESS_DATA_3\{pi}\YEAR\{folder}\GERBL2_2014_ComboA",
        dst_root=fr"D:\GLAM_DASHBOARD\PARQUET_TEST\{pi}\YEAR\{folder}\GERBL2_2014_ComboA")