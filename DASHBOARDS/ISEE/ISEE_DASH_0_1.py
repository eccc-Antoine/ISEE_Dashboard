    ...
    with placeholder3.container():
        ...
        with tab4:            
            ...
            with Col1:
                ...
                if unique_PI_CFG.type == '2D_tiled' or unique_PI_CFG.type == '2D_not_tiled':
                    ...
                    gdf_grille=UTILS.prep_for_prep_1d(unique_PI_CFG.sect_dct, CFG_DASHBOARD.sct_poly, folder, PI_code, baseline_code, unique_PI_CFG.available_years, stat1, var, unique_PI_CFG.mock_map_sct_dct, unique_pi_module_name, start_year2, end_year2)
            ...
            with Col2:
                ...
                if unique_PI_CFG.type == '2D_tiled' or unique_PI_CFG.type == '2D_not_tiled':
                    ...
                    gdf_grille=UTILS.prep_for_prep_1d(unique_PI_CFG.sect_dct, CFG_DASHBOARD.sct_poly, folder, PI_code, ze_plan_code, unique_PI_CFG.available_years, stat1, var2, unique_PI_CFG.mock_map_sct_dct, unique_pi_module_name, start_year2, end_year2)
        ...
        with tab5:        
            ...
            if unique_PI_CFG.type == '2D_tiled' or unique_PI_CFG.type == '2D_not_tiled':
                ...
                gdf_grille_base=UTILS.prep_for_prep_1d(unique_PI_CFG.sect_dct, CFG_DASHBOARD.sct_poly, folder, PI_code, baseline_code, unique_PI_CFG.available_years, stat3, var3, unique_PI_CFG.mock_map_sct_dct, unique_pi_module_name, start_year3, end_year3)
            
                gdf_grille_plan=UTILS.prep_for_prep_1d(unique_PI_CFG.sect_dct, CFG_DASHBOARD.sct_poly, folder, PI_code, ze_plan_code, unique_PI_CFG.available_years, stat3, var3, unique_PI_CFG.mock_map_sct_dct, unique_pi_module_name, start_year3, end_year3)
