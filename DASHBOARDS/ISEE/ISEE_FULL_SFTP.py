...
import CFG_ISEE_SFTP as CFG_DASHBOARD
from DASHBOARDS.UTILS import DASHBOARD_UTILS_SFTP as UTILS
        ...
        with Col2:
            ...
            if len(baselines)==0 or len(available_plans)==0:
                ...
                if unique_PI_CFG.type == '2D_tiled' or unique_PI_CFG.type == '2D_not_tiled':
                    ...
                    gdf_grille_base = UTILS.prep_for_prep_tiles(tiles_shp, folder, PI_code, baseline_code,
                                                                years_list, stat5, var,
                                                                unique_pi_module_name, start_year, end_year, sftp)

                    gdf_grille_plan = UTILS.prep_for_prep_tiles(tiles_shp, folder, PI_code, ze_plan_code,
                                                                years_list, stat5, var,
                                                                unique_pi_module_name, start_year, end_year, sftp)
                    ...
                    gdf_grille_base = UTILS.prep_for_prep_1d(ts_code, unique_PI_CFG.sect_dct, sct_shp, folder,
                                                             ...
                                                             start_year, end_year, Baseline2, sas_token, container_url)
            ...
            if len(baselines)==0 or len(available_plans)==0:
                ...
                if unique_PI_CFG.type == '2D_tiled' or unique_PI_CFG.type == '2D_not_tiled':
                    ...
                    gdf_grille_base = UTILS.prep_for_prep_1d(ts_code, unique_PI_CFG.sect_dct, sct_shp, folder, PI_code,
                                                             ...
                                                             start_year3, end_year3, Baseline, sas_token, container_url)
