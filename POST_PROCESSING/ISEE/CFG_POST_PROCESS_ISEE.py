...
log_name='TURTLE_1D'  # name to add to the log file

pis_2D_tiled=[] #'SAUV_2D', 'IERM_2D', 'CHNI_2D', 'IXEX_RPI_2D'
...
# However, it will be used to select which plans to upload to Azure
