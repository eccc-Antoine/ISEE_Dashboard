...
folder_results = os.path.join(cfg.POST_PROCESS_RES, r'PI_CSV_RESULTS_20260106')
...
print(df_res_all)
output_results = os.path.join(folder_results, f'PIs_SUMMARY_RESULTS_20260106.csv')
